...
const UniRippleMatComponent = class {
    ...
    componentDidLoad() {
        uniRippleMatInit(this.el, this.unbounded);
    }
    render() {
        const classes = uniRippleMatClass(this.color);
        const style = this.inherit ? { 'border-radius': 'inherit' } : {};
        const props = { style };
        return UniHostTemplate({ props, classes }, h("slot", null));
    }
    get el() { return getElement(this); }
};
UniRippleMatComponent.style = rippleMatCss;

const UniButtonMatClasses = {
    button: 'mdc-button',
    ripple: 'mdc-button__ripple',
    label: 'mdc-button__label',
    icon: 'mdc-button__icon',
    flat: 'mdc-button--unelevated',
    raised: 'mdc-button--raised',
    outlined: 'mdc-button--outlined'
};

function uniButtonMatInit(el, isRipple) {
    if (isRipple) {
        uniRippleMatInit(el.querySelector('button'));
    }
}
function uniButtonMatWrapInit(el, kind, isRipple) {
    [].forEach.call(el.children, (child) => {
        addClass(child, UniButtonMatClasses.button);
        addClass(child, UniButtonMatClasses[kind]);
        if (isRipple) {
...
const UniButtonMatTemplate = ({ props, classes }, children) => {
    return (h("button", Object.assign({}, props, { class: classes }),
        h("uni-button-layout-mat", null),
        children));
};

function uniButtonMatKindClass(kind) {
    return {
        [UniButtonMatClasses[kind]]: !!UniButtonMatClasses[kind]
    };
}
function uniButtonMatClass(kind) {
    return Object.assign(Object.assign({}, uniButtonMatKindClass(kind)), { [UniButtonMatClasses.button]: true });
}
function uniButtonRippleMatClass() {
    return {
        [UniButtonMatClasses.ripple]: true
    };
}
function uniButtonLabelMatClass() {
    return {
        [UniButtonMatClasses.label]: true
    };
}
function uniButtonIconMatClass() {
    return {
        [UniButtonMatClasses.icon]: true
    };
}
...
const UniButtonMatComponent = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.type = 'button';
        /**
    ...
    connectedCallback() {
        const { el } = this;
        uniMatWatermark(el, { packages: ['pro'], strict: { el, packages: ['loc'] } });
    }
    componentDidLoad() {
        uniButtonMatInit(this.el, !this.noRipple);
    }
    render() {
        const { type, disabled } = this;
        const props = { type, disabled };
        const classes = uniButtonMatClass(this.kind);
        return UniButtonMatTemplate({ props, classes }, h("slot", null), null);
    }
    get el() { return getElement(this); }
};
UniButtonMatComponent.style = buttonMatCss;

export { UniButtonMatTemplate as U, uniButtonMatInit as a, uniButtonIconMatClass as b, uniButtonLabelMatClass as c, uniButtonMatClass as d, uniButtonMatWrapInit as e, UniButtonMatComponent as f, uniButtonRippleMatClass as u };
